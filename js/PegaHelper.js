 ...
 ***********************************************************************************************************************/
      ...
      (function() {
        ...
        fireflyChatAPI.token = "58d8d9f241c53d0000da406e";
fireflyChatAPI.cobrowseAPIKey="58d3c9aa21365a993bb0fed3";

        fireflyChatAPI.serverHostUrl = "https://Pegaworld18.pegatsdemo.com:8043";
        fireflyChatAPI.assetHostUrl = "https://Pegaworld18.pegatsdemo.com:8043";
        fireflyChatAPI.publishSettingsToS3 = false;
        fireflyChatAPI.s3HostUrl = "https://Pegaworld18.pegatsdemo.com:8043";

        var script = document.createElement("script");
        script.type = "text/javascript";
        script.src = "https://Pegaworld18.pegatsdemo.com:8043/scripts/loaders/chatLoader.js";
        script.async = true;
...
function InvokeAdvisor() {
  ...
  PegaAParamObject.channelId="";  
  pega.web.api.doAction("OnlineHelp", "createNewWork", "PegaCS-OnlineHelp-Triage", "pyStartCase", PegaAParamObject);
 }
...
function monitorPreviewLoader(){   
    if (previewLoaded == false) { 
      ...
      PegaAParamObject.channelId=""; 
	    pega.web.api.doAction("PreviewGadget", "display", "Preview", "PegaCS-OnlineHelp-Triage", null, true, null, PegaAParamObject);	
...
$(function() {
$( 'body' ).append("<div id='ServiceCaseGadget' data-pega-gadgetname ='ServiceCaseGadget' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='CSHCCustomerAdvisor' data-pega-isdeferloaded ='true' data-pega-threadname ='CSServiceCase' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='onServiceCaseClose' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRServletCustom' data-pega-action-param-parameters =''></div>");
$( 'body' ).append("<div id='OnlineHelp' data-pega-gadgetname ='OnlineHelp' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='CSHCCustomerAdvisor' data-pega-isdeferloaded ='true' data-pega-threadname ='CSAdvisor' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRServletCustom' data-pega-action-param-parameters ='' data-pega-redirectguests='true' data-pega-event-onclose ='hideinline'></div>");
$( 'body' ).append("<div id='ChatWrapper'><div id='LocalChatHeader'><div id='HeaderText'>Self-Service Advisor</div><div id='MinimizeChat' title='Minimize chat'>_</div></div><div id='LocalChatSubheader'><div id='SubHeaderText'>Live Chat</div><button class='EndChat' type='button'>End chat</button></div><div id='ChatHolder'></div><div id='ChatFooter'><span>Powered by Pega</span></div></div>");
$( 'body' ).append("<div style='display:none; height:80px; padding-top:14px; padding-left:20px;' id='Preview' data-pega-gadgetname ='PreviewGadget' data-pega-isdeferloaded ='true' data-pega-action ='display' data-pega-action-param-classname ='PegaCS-OnlineHelp-Triage'  data-pega-harnessname ='Preview' data-pega-applicationname ='CSHCCustomerAdvisor' data-pega-threadname ='Preview' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRServletCustom' data-pega-action-param-parameters=''></div>");
});
/***********************************************************************************************************************
