...
function InvokeAdvisor() {
  ...
  PegaAParamObject.channelId="bot2ea4ce8cc35a40b3855d5acf4565f568";  
...
$(function() {
$( 'body' ).append("<div id='ServiceCaseGadget' data-pega-gadgetname ='ServiceCaseGadget' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='CSHCWebChatbot' data-pega-isdeferloaded ='true' data-pega-threadname ='CSServiceCase' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='onServiceCaseClose' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRChat' data-pega-action-param-parameters =''></div>");
$( 'body' ).append("<div id='OnlineHelp' data-pega-gadgetname ='OnlineHelp' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='CSHCWebChatbot' data-pega-isdeferloaded ='true' data-pega-threadname ='CSAdvisor' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRChat' data-pega-action-param-parameters ='' data-pega-redirectguests='true' data-pega-event-onclose ='hideinline'></div>");
$( 'body' ).append("<div id='ChatWrapper'><div id='LocalChatHeader'><div id='HeaderText'>Intelligent Virtual Assistant</div><div id='MinimizeChat' title='Minimize chat'>_</div></div><div id='LocalChatSubheader'><div id='SubHeaderText'>Live Chat</div><button class='EndChat' type='button'>End chat</button></div><div id='ChatHolder'></div><div id='ChatFooter'><span>Powered by Pega</span></div></div>");
$( 'body' ).append("<div style='display:none; height:80px; padding-top:14px; padding-left:20px;' id='Preview' data-pega-gadgetname ='PreviewGadget' data-pega-isdeferloaded ='true' data-pega-action ='display' data-pega-action-param-classname ='PegaCS-OnlineHelp-Triage-WebChatbot'  data-pega-harnessname ='Preview' data-pega-applicationname ='CSHCWebChatbot' data-pega-threadname ='Preview' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='' data-pega-url ='https://pegaworld18.pegatsdemo.com:443/prweb/PRChat' data-pega-action-param-parameters=''></div>");
});
/***********************************************************************************************************************
