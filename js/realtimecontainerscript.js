	...
	var NBAMServiceControl = {
		...
		getServiceURL : function (serviceName,params) {
			...
			if(serviceClass){
				...
				var url = "https://" + this.hostName + ":" + this.port + "/prweb/PRRestService/PegaMKTContainer/Services/"+serviceName+"?";
			}
		...
		getOffers : function (customerID, containerName, channel, previousPage, currentpage, callback) {
			...
			var jsonObj = this.getJSONObj(customerID, containerName, channel, previousPage, currentpage);
